...
function areaDelTriangulo(base, altura){
  ...
  //Escribe tu código aquí
  var araeTriangulo = (base * altura) /2;
  return araeTriangulo;
...
function deEuroAdolar(euro){
  ...
  //Escribe tu código aquí
  var tipoCambio = 1.20;
  var EuroaDolar = euro*tipoCambio;
  return EuroaDolar;
}
...
function esVocal(letra){
  ...
  || letra === 'U' ){ var mensaje = 'Es vocal'; return mensaje;}

  else{
      var mensajeError2 = 'Dato incorrecto';
